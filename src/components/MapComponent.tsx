...
import { House, MessageCircleHeart, PlaneTakeoff, Locate } from "lucide-react";
...
function RecenterControl({ center, zoom, lang }: { center: [number, number]; zoom: number, lang: "fr" | "es" }) {
  const map = useMap();
